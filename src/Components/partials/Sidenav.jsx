    ...
    <div className='w-[20%] h-full p-5 border-r border-zinc-400'>
        ...
        <div className='flex flex-col text-white mt-5'>
            ...
            <nav className='flex flex-col text-zinc-400'>
                <Link className='p-5 hover:bg-[#6556CD] hover:text-white duration-300 rounded-md'><i className="ri-fire-fill"></i> Trending</Link>
                <Link className='p-5 hover:bg-[#6556CD] hover:text-white duration-300 rounded-md'><i className="ri-bard-fill"></i> Popular</Link>
