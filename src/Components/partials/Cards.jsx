...
const Cards = ({data}) => {
  return (
    <div className='w-full min-h-[50vh]'>
      <div className='w-[100%] h-[85%] gap-5 mobile:flex-wrap mobile:overflow-y-auto flex overflow-y-hidden mobile:overflow-x-hidden overflow-x-auto pb-5'>
        {data.map((element,index) => (
          <div key={index} className='min-w-[17%] h-[full] bg-zinc-900 shadow-lg hover:scale-105 flex flex-col gap-2 mobile:gap-0 mt-3 rounded overflow-hidden'>
